    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">A Propos de la commune Est-Mono2</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-lg-7">
                        <form action="{{ route('admin.about.commune-store', $about) }}" method="post" enctype="multipart/form-data" id="createForm">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="commune" id="text" class="form-control description">{!! $about->text !!}</textarea>
                            </div>
