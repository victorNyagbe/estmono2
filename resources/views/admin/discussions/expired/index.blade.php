    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Conversations expirées</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <tbody>
                                    @forelse ($discussions as $discussion)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $message }}</td>
                                            <td><a href="{{ route('admin.conversationNotClosedButExpiredShow', $discussion) }}" class="readMore">Lire la conversation</a></td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center">Aucune discussion expirée n'a été retrouvée</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
