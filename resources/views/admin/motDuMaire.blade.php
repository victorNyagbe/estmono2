    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Mot du Maire</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Accueil</a></li>
                            <li class="breadcrumb-item active">Mot du Maire</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-5 mb-4">
                        ...
                        <img src="{{ asset('storage/app/public/' . $maire->image) }}" alt="" class="img-fluid img-thumbnail">
                    </div>

                    <div class="col-12 col-lg-7">
                        <form action="{{ route('admin.motDuMaire.update', $maire) }}" method="post" enctype="multipart/form-data" id="createForm">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group">
                               ...
                               <textarea name="text" id="text" class="form-control description">{!! $maire->text !!} </textarea>
                            </div>
