...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('styles/visitors/css/project/devenirPartenaireShow.css') }}">
@endsection
...
<section class="contenu">
    <div class="fond-filter">
        ...
        <!-- Stack the columns on mobile by making one full-width and the other half-width -->
            <div class="row mt-3">
                <div class="col-md-8">
                    <p><a href="{{ route('guests.projects.devenirPartenaire') }}" style="font-size:1.2em;text-decoration:none;" class="return-projet">&larr; Les projets</a></p>
                    <div class="card mb-3 big-show">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><span><i class="bi bi-calendar-date"></i></span> <small class="text-muted" style="font-style:italic;"> Postée le, {{ \Carbon\Carbon::parse($project->created_at)->format('d/m/Y') }}</small></p>
                                <a href="#" class="partner-text">Devenir partenaire</a>
                                            ...
                                            <p class="card-text">
                                                <small class="text-muted small-show-date">Postée le {{ \Carbon\Carbon::parse($other_project->created_at)->format('d/m/Y') }}
                                                    <span style="font-size: 1.2em;font-style:normal;">
                                                        <a class="small-show-link" href="{{ route('guests.projects.devenirPartenaireShow', $other_project) }}">lire plus</a></br>
                                                    </span>
                                                </small>
                                            </p>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="partner-block">
                                <div class="partner-content">
                                    <div>
                                        <h4 class="partner-title">Devenir partenaire</h4>
                                        <hr class="hr1">
                                    </div>
                                    <div class="col-12 partner-btn">
