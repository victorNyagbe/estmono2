...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('styles/visitors/css/project/index.css') }}">
@endsection
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7 justify-content-center">
                    <div class="title-index">
                        <h1>Plan de developpement communal</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-lg-4 d-flex align-items-stretch cadre-projet" data-aos="fade-up" data-aos-delay="100">
                            <div class="projet">
                                ...
                                <div class="projet-info">
                                    ...
                                    <a href="{{ route('guests.projects.show', $project) }}" >TOUT LIRE</a>
                                </div>
                            </div>
                        </div>
                     @endforeach
