...
@section('style')
    ...
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('storage/app/public/' . $project->image) }}">

    <!-- Twitter Card Meta Tags -->
    <meta property="twitter:title" content="{{ $project->title }}">
    <meta property="twitter:description" content="{!! $project->subtitle . '...' !!}">
    <meta property="twitter:image" content="{{ asset('storage/app/public/' . $project->image) }}">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="{{ $project->title }}">
    <meta property="og:description" content="{!! $project->subtitle . '...' !!}">
    <meta property="og:image" content="{{ asset('storage/app/public/' . $project->image) }}" style="width: 1200px; height: 630px;">
...
<section class="contenu">
    <div class="fond-filter">
        ...
        <!-- Stack the columns on mobile by making one full-width and the other half-width -->
            <div class="row mt-3">
                <div class="col-md-8">
                    <p><a href="{{ route('guests.projects.projetEnCour') }}" style="font-size:1.2em;text-decoration:none;" class="return-projet">&larr; Les projets</a></p>
                                            ...
                                            <p class="card-text">
                                                <small class="text-muted small-show-date">Postée le {{ \Carbon\Carbon::parse($other_project->created_at)->format('d/m/Y') }}
                                                    <span style="font-size: 1.2em;font-style:normal;">
                                                        <a class="small-show-link" href="{{ route('guests.projects.projetEnCourShow', $other_project) }}">lire plus</a></br>
                                                    </span>
                                                </small>
                                            </p>
                                        </div>
