...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('styles/visitors/css/services/social/age.css') }}">
@endsection

@section('content')
    <div class="banner-background">
        <div class="banner-filter">
            <h4 class="banner-title text-center animate__animated animate__rotateInUpLeft animate__repeat-1 animate__slower">Actions sociales</h4>
        </div>
        {{-- <div class="links-btn">
            <div id="slide1" class="links-title slide pointerCursor">
                <a href="{{ route('guests.services.social.handicape') }}">Personnes handicapés</a>
            </div>
...
Sur le plan associative et participative la commune encourage la participation et l’implication des habitants dans la vie locale en soutenant le tissu associatives citoyennes.
                ...
                <div class="col-12 projet-title">
                    <h4>
                        Projets et réalisations de la commune dans le domaine du social
                    </h4>
                </div>
                <div class="col-12">
                    <p class="text-center">
                ...
                <!-- <div class="col-12 col-md-4 py-4">
                    <div class="age-img"></div>
                    <p class="statut">En cours</p>
                    <div class="description">
                        <h6>
                            Journée pour personnes agées
                        </h6>
                    </div>
                </div>
                <div class="col-12 col-md-4 py-4">
                ...
                <div class="col-12 col-md-4 py-4">
                    <div class="femm-img"></div>
                    <p class="statut">En cours</p>
                    <div class="description">
                        <h6>
                            Marché des femmes de lomé
                        </h6>
                    </div>
                </div> -->
                ...
                <div class="col-12 school-title">
                    <h4>
                        Services sociaux dans la commune
                    </h4>
                </div>
                <!-- <div class="col-12">
                    <p>
    ...
    <script>
        $('document').ready(function () {
            ...
            $("#slide1").click(function(){
                window.location.href="http://localhost/golfe1/nos-services/social/handicapes"
            });
