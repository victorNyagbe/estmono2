...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('styles/visitors/css/services/social/femme.css') }}">
@endsection

@section('content')
    <div class="banner-background">
        <div class="banner-filter">
            <h4 class="banner-title text-center animate__animated animate__rotateInUpLeft animate__repeat-1 animate__slower">Femmes</h4>
        </div>
        <div class="links-btn">
...
Sur le plan associative et participative la commune encourage la participation et l’implication des habitants dans la vie locale en soutenant le tissu associatives citoyennes.
                ...
                <div class="col-12 projet-title">
                    <h4>
                        Projets et réalisations de la commune pour les femmes
                    </h4>
                </div>
                <div class="col-12">
                    <p>
                ...
                <div class="col-12 school-title">
                    <h4>
                        Services sociaux (pour les femmes) dans la commune
                    </h4>
                </div>
                <div class="col-12">
                    <p>
