...
@section('content')
    ...
    <section id="person" class="person section-bg">
            <div class="container" data-aos="fade-up" style="background-color: rgba(255, 255, 255, 0.6)">

                <div class="row justify-content-center">
                    <div class="col-12 col-md-10" data-aos="fade-up" data-aos-delay="100">
                        <div class="d-flex justify-content-center">
                            {{-- <img src="{{ asset('assets/images/bureau.jpeg') }}" alt="" class="img-fluid"> --}}
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="section-title">
                    <h1>MEMBRES DU BUREAU EXECUTIF DE LA COMMUNE GOLFE 1</h1>
                </div> --}}
                ...
                <div class="section-title mt-5">
                    <h1>MEMBRES DU CONSEIL MUNICIPAL DE LA COMMUNE EST-MONO 2</h1>
                </div>
