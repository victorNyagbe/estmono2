...
//     select('#navMob').innerHTML = navMenu
...
document.addEventListener('click', function(e) {
    if (e.target.matches('.mobile-nav-toggle')) {
        ...
        const navMenu = document.querySelector('#navbar').innerHTML;
        let navMob = document.querySelector('#navMob');

        navMob.innerHTML = '';

        // Toggle the visibility of the mobile navigation menu
        if (navMob.style.display === 'none' || navMob.style.display === '') {
            e.target.classList.toggle('bi-list');
            e.target.classList.toggle('bi-x');
            navMob.innerHTML = navMenu;
            navMob.style.display = 'flex';  // Show the menu
        } else {
            e.target.classList.toggle('bi-x');
            e.target.classList.toggle('bi-list');
            navMob.style.display = 'none';  // Hide the menu
        }
    }
});
...
document.querySelector('#navMob').addEventListener('click', function(e) {
    // Check if the clicked element is a link inside a dropdown

    if (e.target.matches('.drop-link')) {
